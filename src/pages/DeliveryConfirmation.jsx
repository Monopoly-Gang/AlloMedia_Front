...
const DeliveryConfirmation = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      ...
      const mockOrders = [
        ...
        { id: 3, customerName: 'Bob Johnson', address: '789 Oak St, Village', phone: '111-222-3333', items: ['Salad', 'Water'] },
      ];
  ...
  const handleOtpConfirmation = async (otp) => {
    // Replace this with actual API call to confirm delivery
  ...
  return (
    <section className="py-10 bg-slate-50 dark:bg-slate-900 md:py-20 lg:py-14">
      ...
      <h1 className="text-3xl font-bold mb-8 text-slate-800 dark:text-slate-100">Active Deliveries</h1>
